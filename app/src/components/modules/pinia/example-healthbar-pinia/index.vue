...
<template>
  <island title="Example healthbar pinia">
    ...
    <br />
    <el-text
      >health in this component (conduct by Deconstruction): {{ health }}, (use
      storeToRef to be reactive)
    </el-text>
    <br />
    <el-button @click="healthStore.increment()">increment</el-button>
    <el-button style="margin-left: 10px" @click="add(2)"
      >add (conduct by Deconstruction)
    </el-button>
  </island>
</template>