...
import VueUseMousePosition from "./components/vue-use/vue-use-mouse-position.vue";
import SortableDiv from "./components/vue-use/sortable-div.vue";
...
<template>
  ...
  <vue-use-mouse-position></vue-use-mouse-position>
</template>
